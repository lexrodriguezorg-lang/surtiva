...
for (const file of ['operacion.css', 'tienda.css', 'plataforma.css', 'brand.css', 'brand-tokens.css','entrance.css','commerce.css','visits.css','catalog.css','supplier.css','commercial-shell.css']) {
